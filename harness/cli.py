...
def build_parser() -> argparse.ArgumentParser:
    ...
    generate.add_argument("--n-per-rule", type=int, default=6)
    generate.set_defaults(
        func=cmd_unimplemented,
        reason=(
            "Probe generation is DESIGN.md 3.2. The 30 probes this build runs "
            "were hand-written by scripts/author_probes.py."
        ),
    )
